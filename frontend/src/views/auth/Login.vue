  ...
  <div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div class="text-sm">
          <RouterLink to="/auth/magic-link" class="font-medium text-primary-600 hover:text-primary-500">
...
const { login, isLoading, getGoogleAuthUrl, getLinkedInAuthUrl } = useAuth()
